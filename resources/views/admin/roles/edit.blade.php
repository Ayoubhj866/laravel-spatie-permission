    ...
    <div class="w-full p-2 py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                ...
                <section class="py-1 py-6 bg-blueGray-50">
                    <div class="w-full px-4 mx-auto mt-24 mb-12 xl:w-8/12 xl:mb-0">
                        ...
                        <div class="mt-6">
                            ...
                            @if ($role->permissions)
                                <ul>
                                    @foreach ($role->permissions as $role_permission)
                                        <form
                                            action="{{ route('admin.roles.permission.delete', ['role' => $role, 'permission' => $role_permission->name]) }}"
                                            method='POST'
                            ...
                            @else
                                <small class="leading-relaxed text-green-500">Assign permissions to
                                    this
                                    role.</small>
                            @endif
                        ...
                        <div class="mt-6">
                            <form action="{{ route('admin.roles.permission.store', $role) }}" method="POST">
                                @csrf

                                <h2 class="mb-1 text-lg font-medium text-white title-font">Assign Permissions</h2>
                                ...
                                <div class="relative mb-4">
                                    ...
                                    <select name="permission" id=""
                                        ...
                                        @forelse ($permissions as $key => $name)
